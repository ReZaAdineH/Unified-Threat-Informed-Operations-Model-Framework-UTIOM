# UTIOM Software Licence

Copyright © 2026 Reza Adineh.

UTIOM software and self-hosted implementation components identified by the repository licensing map are offered under the following **unmodified PolyForm Internal Use License 1.0.0**.
